  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        generator: {
          filename: isDev
            ? 'assets/img/[name][ext][query]'
            : 'assets/img/[contenthash][ext][query]',
        },
        parser: {
          dataUrlCondition: {
            maxSize: 4096,
      ...
      },
      {
        ...
        generator: {
          filename: isDev
            ? 'assets/media/[name][ext][query]'
            : 'assets/media/[contenthash][ext][query]',
        },
      },
      {
        ...
        generator: {
          filename: isDev
            ...
            : 'assets/fonts/[contenthash][ext][query]',
        },
      },
      {
        test: /\.svg(\?v=\d+\.\d+\.\d+)?$/,
