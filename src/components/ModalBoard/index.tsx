...
export const ModalBoard: React.FunctionComponent<IModalProps> = props => {
  ...
  const onClick = () => {
    ...
    props.addDataCard({ id: Date.now(), title: titleBoard, description: descriptionBoard });
  };
    ...
    <div id="myModal" className="modal">
      <div className="modal-content">
        ...
        <div className="wrapper-input">
          ...
          {isVisibleErrorTitle && <span className="error-modal">Fill in this field!</span>}
          <label>Description</label>
          <textarea className="textarea-description" onChange={descriptionOnChange} />
          {isVisibleErrorDescription && <span className="error-modal">Fill in this field!</span>}
